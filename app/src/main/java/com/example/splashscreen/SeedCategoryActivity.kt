...
class SeedCategoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.seed_category)
        ...
        searchInput.setOnEditorActionListener { _, actionId, event ->
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                ...
                val intent = Intent(this@SeedCategoryActivity, SearchProdukActivity::class.java).apply {
    ...
    private fun displayProducts(products: List<ProductData>, reviews: List<ReviewData>, gridLayout: GridLayout) {
        ...
        for ((index, product) in sortedProducts.withIndex()) {
            ...
            cardView.setOnClickListener {
                val intent = Intent(this@SeedCategoryActivity, ProdukActivity::class.java).apply {
