...
class PoultryCategoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.poultry_category)
        ...
        searchInput.setOnEditorActionListener { _, actionId, event ->
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                ...
                val intent = Intent(this@PoultryCategoryActivity, SearchProdukActivity::class.java).apply {
